...
Pre-release testing: `2026.02.21b10` adds structure-level `ApplicationKeysTrait` ingestion and lock+structure key merging for passcode encryption material resolution.
