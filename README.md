...
## Pre-release 2025.12.18b4 - Fix command response handling (beta)

- Fix regression where some gRPC error responses were incorrectly logged as “Command succeeded”.
- Commands and settings updates now reliably detect `StreamBody.status` errors (e.g. code=4, code=6) and surface them properly.

> To test via HACS: enable “Show beta versions” for this repository in HACS and select version `2025.12.18b4`.
