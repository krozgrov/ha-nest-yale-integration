...
- 2026-02-15: Re-aligned naming with nest_legacy by reverting canonical name to `LabelSettingsTrait` (`name`) plus location prefix (`where_label`) for display; `door_label` remains attribute context and no longer drives name composition.
