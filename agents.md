...
All AI-generated output:
	...
	•	Should clearly indicate areas needing validation
	•	Should never be assumed correct without verification
...
AI agents must assume that control and context files such as agents.md and DEV_NOTES.md:
...
This format:
	...
	•	Avoids semantic version ambiguity during rapid iteration
	•	Aligns clearly with release timelines
